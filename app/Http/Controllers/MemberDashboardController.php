    ...
    private function createPayMongoCheckout(Payment $payment)
{
    ...
    public function workoutPdf()
    {
        ...
        $pdf = Pdf::loadView('member.pdf.workouts', compact(
            'member',
            'workouts'
        ));

        return $pdf->stream('WorkoutSchedule.pdf');
    }
    ...
    public function paymentPdf()
    {
        ...
        $pdf = Pdf::loadView('member.pdf.payments', compact(
            'member',
            'payments'
        ));
