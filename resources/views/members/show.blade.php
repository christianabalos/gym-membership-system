...
<body>
    <div class="container">
        ...
        <div class="details-box">
            ...
            <div class="detail-row">
                <div class="label">Health Declaration:</div>

                <div class="value">

                    @if($member->health_declaration)

                        {!! nl2br(e($member->health_declaration)) !!}

                    @elseif($member->no_health_issue)
            ...
            <div class="detail-row">
                ...
                <div class="value">{{ $member->emergency_name ?: 'N/A' }}</div>
            </div>

            <div class="detail-row">
                <div class="label">Relationship:</div>
                <div class="value">{{ $member->emergency_relationship ?: 'N/A' }}</div>
            </div>
            ...
            <div class="detail-row">
                ...
                <div class="value">
                    @if($member->emergency_phone)
                        <a href="tel:{{ $member->emergency_phone }}"
