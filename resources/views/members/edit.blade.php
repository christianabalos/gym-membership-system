...
<<<<<<< HEAD
                    <div class="form-group">
                        ...
                        <textarea                        
                            ...
                            rows="4"
                            style="width:100%; padding:12px 14px; border-radius:9px; border:1px solid rgba(203,213,225,0.95); font-size:14px; background:rgba(255,255,255,0.95); color:#111827;"
                        >{{ old('health_declaration', $member->health_declaration) }}</textarea>
                        ...
                        <div class="form-group">
                            <label>
                                <input
                                    ...
                                    value="1"
                                    {{ old('no_health_issue', $member->no_health_issue) ? 'checked' : '' }}
                                    style="width:auto; margin-right:8px;"
                                >

                                I have no known illnesses or medical conditions.
                            </label>
                        ...
                        <div class="note">
                            List any medical conditions, allergies, injuries, or other health concerns.
                        </div>
                    </div>                                 
...
>>>>>>> fcad23c5ab6fcb4e40e7d4d0b86f52da3ecfa38c
        ...
        <script>
            const checkbox = document.getElementById('no_health_issue');
            const textarea = document.getElementById('health_declaration');
            ...
            checkbox.addEventListener('change', toggleHealthDeclaration);
